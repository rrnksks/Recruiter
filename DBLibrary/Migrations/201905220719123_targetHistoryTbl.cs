namespace DBLibrary.Migrations
{
    ...
    public partial class targetHistoryTbl : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                "dbo.RIC_TargetsHistory",
                c => new
                    {
                        RT_ID = c.Int(nullable: false, identity: true),
                        RT_ReportingId = c.Int(nullable: false),
        ...
        {
            DropTable("dbo.RIC_TargetsHistory");
        }
    }
}
